    ...
    <body>
        <?php
            if(isset($_GET["usuario"])){ //Se comprueba si se ha pasado algún usuario en la url
                ...
                //echo $usuarioVerificar;
                foreach($arrayUsuarios as $usuarioDato){
                    echo $usuarioDato->getNombreUsuario().", ".$usuarioDato->getContraseña().", ".$usuarioDato->getRol().", ".$usuarioDato->getEmail().", ".$usuarioDato->getActivado().", ".$usuarioDato->getPuntuacionString()."<br/>";
                }
                echo $arrayUsuarios[7]->getNombreUsuario();
                ...
                if($verificado){
                    ...
                    echo "<h4 style='color:green; text-align:center'>Usuario ".$usuarioVerificar." verificado!</h4>"; //Mensaje que verá el usuario cuando verifiquemos su usuario
                }else
