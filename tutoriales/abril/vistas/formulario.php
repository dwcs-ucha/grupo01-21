    ...
    <form action="./formulario.php" method="post">
        <p><?php echo $preguntas[0]->cod;?>. <?php echo $preguntas[0]->enunciado;?></p>
            <select name="extension">
                ...
                <option value="<?php print $preguntas[0]->respuesta; ?>">Lápiz</option>
        ...
        <?php echo $preguntas[4]->enunciado;?></p>
            <label><input type="checkbox" name="eficiencia[]" value="<?php print $preguntas[4]->respuesta[0] ?>">Utilizar bombillas económicas</label><br>
            <label><input type="checkbox" name="eficiencia[]" value="<?php print $preguntas[4]->respuesta[1] ?>">Elegir electrodomésticos eficientes</label><br>
            <label><input type="checkbox" name="eficiencia[]" value="luces">Dejar las luces encendidas toda la noche</label><br>
